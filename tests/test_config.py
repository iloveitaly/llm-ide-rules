...
def test_gemini_config_warning_in_explode():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert "Warning: Gemini CLI configuration missing for AGENTS.md." in result.stdout
...
def test_gemini_config_warning_not_shown_when_present():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        gemini_dir.mkdir()
        (gemini_dir / "settings.json").write_text('{"agent.instructionFile": "AGENTS.md"}')
        ...
        assert "Warning: Gemini CLI configuration missing for AGENTS.md." not in result.stdout
